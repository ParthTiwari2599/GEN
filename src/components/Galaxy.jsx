...
void main() {
  ...
  if (uMouseRepulsion) {
    ...
    uv += repulsion * 0.25 * uMouseActiveFactor;
  ...
  gl_FragColor = vec4(col, uTransparent ? clamp(length(col), 0.0, 1.0) : 1.0);
}
`;
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    gl.clearColor(0, 0, 0, transparent ? 0.0 : 1.0);
    ...
    function handleMouseMove(e) {
      ...
      targetMousePos.current.y = 1 - (e.clientY - rect.top) / rect.height;
    ...
    return () => {
      ...
      if (ctn && ctn.contains(gl.canvas)) ctn.removeChild(gl.canvas);

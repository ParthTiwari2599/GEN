...
const Home = () => {
  ...
  async function getResponse() {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        Generate a modern, animated, responsive UI component for: ${prompt}
        Framework: ${frameWork.value}
        Return ONLY full working code inside one HTML file, formatted in Markdown code blocks.
        `
      });
  ...
  return (
    <>
      {/* 🌟 Top-left brand */}
      <div className="fixed top-4 left-6 z-50 pointer-events-none">
        <h1 className="text-3xl md:text-4xl font-extrabold text-purple-400 tracking-wide drop-shadow-[0_0_12px_rgba(168,85,247,0.65)]"
